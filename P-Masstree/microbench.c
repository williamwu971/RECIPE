...
int main(int argc, char **argv) {
    ...
    char *path = "/pmem0/masstree_log_logs";   // benched file
    ...
    } stop_timer("Doing %ld memcpy of %ld bytes (%f MB/s)", nb_accesses, granularity, bandwith(nb_accesses*granularity, elapsed));
